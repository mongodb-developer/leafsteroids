namespace _00_Shared
{
    public static class Constants
    {
        ...
        public const string GetPlayersEndpoint =
            "https://eu-west-1.aws.data.mongodb-api.com/app/gdc_2023-tzwoy/endpoint/players";

        public const string GetConfigEndpoint =
            "https://eu-west-1.aws.data.mongodb-api.com/app/gdc_2023-tzwoy/endpoint/config";
